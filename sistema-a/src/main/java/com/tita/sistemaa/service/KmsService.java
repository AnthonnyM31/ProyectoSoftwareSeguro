package com.tita.sistemaa.service;
 ...
 * cifrar datos planos usando el algoritmo simetrico configurado.
 */
@Service
public class KmsService {
    ...
    public String encrypt(String plaintext) {
        try {
            String url = vaultUrl + "/v1/transit/encrypt/tita-key";
            ...
            body.put("plaintext", base64Plaintext);
            ...
            if (response.getStatusCode().is2xxSuccessful() && response.getBody() != null) {
                ...
                return String.valueOf(data.get("ciphertext"));
            }
            throw new RuntimeException("Error en respuesta de Vault: " + response.getStatusCode());
        } catch (Exception e) {
            throw new RuntimeException("Error al conectar con Vault KMS para cifrar", e);
        }
    }
}
